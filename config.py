...
OWNER_TAG = os.environ.get("OWNER_TAG", "@IntrovertSama")
UPI_ID = os.environ.get("UPI_ID", "nikhilsama@fam")
QR_PIC = os.environ.get("QR_PIC", "https://i.ibb.co/kVjDJYPX/IMG-20251003-WA0000.jpg")
SCREENSHOT_URL = os.environ.get("SCREENSHOT_URL", f"t.me/IntrovertSama0")
#--------------------------------------------
#Time and its price
#7 Days
